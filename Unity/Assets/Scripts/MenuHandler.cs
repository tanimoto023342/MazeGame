...
public class MenuHandler : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GenerateMenuBtn("Level Select", 0, 224, () => SceneHandler.LoadLevelSelectScene(isFreeWorldMode: false,deleteiscanplaynumdata: false));
        ...
        // Fix for CS0121: Ensure the correct overload of LoadCreditScene is called explicitly
